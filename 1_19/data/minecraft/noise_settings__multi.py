...
def reference_file(patch_path: Path, patch_version_config: ty.Dict[str, str]) \
    ...
    path_source_common = Path('vanilla_noise') / '1_19'
    path_target_common = patch_path.parent / 'worldgen' / 'noise_settings'

    return [
        ('COMMON', path_source_common / '1_19_end.json', path_target_common / 'end_1.json'),
        ('COMMON', path_source_common / '1_19_end.json', path_target_common / 'end_2.json'),
        ('COMMON', path_source_common / '1_19_overworld.json', path_target_common / 'overworld.json'),
        ('COMMON', path_source_common / '1_19_nether.json', path_target_common / 'nether.json')
    ]
