...
def reference_file(patch_path: Path, patch_version_config: ty.Dict[str, str]) \
    ...
    return [
        ('COMMON', path_source_common / '1_21_9' / '1_21_9_end.json', path_target_common / 'end_1.json'),
        ('COMMON', path_source_common / '1_21_9' / '1_21_9_end.json', path_target_common / 'end_2.json'),
        ('COMMON', path_source_common / '1_21_9' / '1_21_9_overworld.json', path_target_common / 'overworld.json'),
