...
def reference_file(patch_path: Path, patch_version_config: ty.Dict[str, str]) \
    ...
    dir_source_1 = Path('vanilla_biomes/1_20_2_overworld')
    dir_source_2 = Path('vanilla_biomes/1_20_5_overworld_patch')
    dir_source_3 = Path('vanilla_biomes/1_21_overworld_patch')
    dir_target = patch_path.parent / 'worldgen' / 'biome'
    return [
        ('COMMON', dir_source_1, dir_target),
        ('COMMON', dir_source_2, dir_target),
        ('COMMON', dir_source_3, dir_target),
    ]
