...
def reference_file(patch_path: Path, patch_version_config: ty.Dict[str, str]) \
    ...
    return [
        ('MC_1_19', path_portal_feature, path_portal_feature),
        ('MC_1_19', path_placed_nether, path_placed_nether),
        ('MC_1_19', path_placed_overworld, path_placed_overworld),
        ('MC_1_19', path_placed_warped, path_placed_warped)
    ]
